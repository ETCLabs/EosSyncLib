#############################################################################
# Makefile for building: bin/EosSyncLib
# Generated by qmake (3.1) (Qt 5.8.0)
# Project:  EosSyncLib.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile EosSyncLib.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = EosSyncLib1.0.0
DISTDIR = /home/ilumnatr/projects/EosSyncLib/.tmp/EosSyncLib1.0.0
LINK          = g++
LFLAGS        = 
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		EosSyncLib.pro EosSyncLib/EosLog.h \
		EosSyncLib/EosOsc.h \
		...
		EosSyncLib/EosTcp_Nix.h \
		EosSyncLib/EosUdp_Nix.h EosSyncLib/EosLog.cpp \
		EosSyncLib/EosOsc.cpp \
		EosSyncLib/EosSyncLib.cpp \
		EosSyncLib/EosTcp.cpp \
		EosSyncLib/EosTimer.cpp \
...
Makefile: EosSyncLib.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile EosSyncLib.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents EosSyncLib/EosLog.h EosSyncLib/EosOsc.h EosSyncLib/EosSyncLib.h EosSyncLib/EosTcp.h EosSyncLib/EosTimer.h EosSyncLib/EosUdp.h EosSyncLib/OSCParser.h EosSyncLib/EosTcp_Nix.h EosSyncLib/EosUdp_Nix.h $(DISTDIR)/
	$(COPY_FILE) --parents EosSyncLib/EosLog.cpp EosSyncLib/EosOsc.cpp EosSyncLib/EosSyncLib.cpp EosSyncLib/EosTcp.cpp EosSyncLib/EosTimer.cpp EosSyncLib/EosUdp.cpp EosSyncLib/main.cpp EosSyncLib/OSCParser.cpp EosSyncLib/EosTcp_Nix.cpp EosSyncLib/EosUdp_Nix.cpp $(DISTDIR)/
...
EosLog.o: EosSyncLib/EosLog.cpp EosSyncLib/EosLog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EosLog.o EosSyncLib/EosLog.cpp

EosOsc.o: EosSyncLib/EosOsc.cpp EosSyncLib/EosOsc.h \
		EosSyncLib/OSCParser.h \
		EosSyncLib/EosTcp.h \
		EosSyncLib/EosLog.h \
		EosSyncLib/EosTimer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EosOsc.o EosSyncLib/EosOsc.cpp

EosSyncLib.o: EosSyncLib/EosSyncLib.cpp EosSyncLib/EosSyncLib.h \
		EosSyncLib/EosLog.h \
		EosSyncLib/EosOsc.h \
		EosSyncLib/OSCParser.h \
		EosSyncLib/EosTcp.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EosSyncLib.o EosSyncLib/EosSyncLib.cpp

EosTcp.o: EosSyncLib/EosTcp.cpp EosSyncLib/EosTcp.h \
		EosSyncLib/EosLog.h \
		EosSyncLib/EosTcp_Win.h \
		EosSyncLib/EosTcp_Mac.h \
		EosSyncLib/EosTcp_Nix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EosTcp.o EosSyncLib/EosTcp.cpp

EosTimer.o: EosSyncLib/EosTimer.cpp EosSyncLib/EosTimer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EosTimer.o EosSyncLib/EosTimer.cpp

EosUdp.o: EosSyncLib/EosUdp.cpp EosSyncLib/EosUdp.h \
		EosSyncLib/EosUdp_Win.h \
		EosSyncLib/EosUdp_Mac.h \
		EosSyncLib/EosUdp_Nix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EosUdp.o EosSyncLib/EosUdp.cpp

main.o: EosSyncLib/main.cpp EosSyncLib/EosSyncLib.h \
		EosSyncLib/EosLog.h \
		EosSyncLib/EosOsc.h \
		EosSyncLib/OSCParser.h \
		EosSyncLib/EosTimer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o EosSyncLib/main.cpp

OSCParser.o: EosSyncLib/OSCParser.cpp EosSyncLib/OSCParser.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o OSCParser.o EosSyncLib/OSCParser.cpp

EosTcp_Nix.o: EosSyncLib/EosTcp_Nix.cpp EosSyncLib/EosTcp_Nix.h \
		EosSyncLib/EosTcp.h \
		EosSyncLib/EosLog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EosTcp_Nix.o EosSyncLib/EosTcp_Nix.cpp

EosUdp_Nix.o: EosSyncLib/EosUdp_Nix.cpp EosSyncLib/EosUdp_Nix.h \
		EosSyncLib/EosUdp.h \
		EosSyncLib/EosLog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o EosUdp_Nix.o EosSyncLib/EosUdp_Nix.cpp
